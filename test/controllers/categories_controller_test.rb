...
class CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_create_category
    post admin_categories_path, params: { category: { name: "NASA", user_id: @user.id } }, as: :json
    assert_response :ok
  ...
  def test_should_show_all_categories
    get public_categories_path, as: :json
    assert_response :ok
    response_json = response.parsed_body
  ...
  def test_should_delete_category
    @category.save
    delete admin_category_path(@category.id), as: :json
    assert_response :ok
    response_json = response.parsed_body
  ...
  def test_should_update_category
    ...
    put admin_category_path(@category.id), params: category_params, as: :json
  ...
  def test_should_update_categories_positions
    ...
    put position_update_admin_categories_path, params: { category_id_list: category_id_list }, as: :json
    assert_response :success
